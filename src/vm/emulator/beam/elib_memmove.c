...
static void copy_high(char* dst, char* src, int n);
static void copy_low(char* dst, char* src, int n);
...
char* dst; char* src; int n;
{
	...
	else if ((((u_long) src) & 3) == 2) { // This was originally u_short src... could cause problems?
